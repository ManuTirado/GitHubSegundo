 ...
 * Use the [RuedaColores.newInstance] factory method to
 * create an instance of this fragment.
 */
class RuedaColores : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_rueda_colores, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnVerde.setOnClickListener{
            listener?.onClickVerde()
        }
        btnRojo.setOnClickListener{
            listener?.onClickRojo()
        }
        btnAmarillo.setOnClickListener{
            listener?.onClickAmarillo()
        }
        btnAzul.setOnClickListener{
            listener?.onClickAzul()
        }
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment RuedaColores.
         */
