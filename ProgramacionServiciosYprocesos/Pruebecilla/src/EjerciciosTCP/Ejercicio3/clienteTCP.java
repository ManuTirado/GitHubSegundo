...
public class clienteTCP {
    public static void main(String[] args) {
        try {
            ...
            do {
                socketCliente = new Socket(direccion, 2000);
                ...
                respuestaServidor = bufferedReader.readLine();
                System.out.println("Mensaje enviado por el servidor: " + respuestaServidor);
            ...
            } while (!respuestaServidor.equals("Correcto"));
